...
public class DotNetCSProjModel {
     ...
     */
    @JsonCreator
    public DotNetCSProjModel(@JsonProperty(value = "ItemGroup") @JsonDeserialize(using = DotNetDependencyDeserializer.class ) @Nullable List<DotNetDependencyLocation> dependencies) {
